# **Fortgeschrittene Webentwicklung Hausaufgabe 1 Backend**
...
## Routen
- Alle Routen sind als POSTMAN-Collection auch unter dem Ordner [postmanCollection](postmanCollection) als JSON-File abgelegt. 
